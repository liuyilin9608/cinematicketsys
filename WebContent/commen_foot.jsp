            ...
            <div class="row">
                <div class="col-md-7 col-md-offset-0 col-sm-10 col-sm-offset-1">
                    <div class="text-center">
                        <img src="${pageContext.request.contextPath}/UI/assets/img/dulau.jpg" alt="Rounded Image" class="img-rounded img-responsive img-dog">
                    </div>
                </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-md-offset-3 col-md-12 text-center">
                <h1 class="hello text-center">
                   <a href="#">Get Shit Done Kit <span class="label label-warning"> Pro</span></a>
                   <small>
                 ...
                 <div class="actions">
                     <a class="btn btn-lg btn-warning btn-fill" href="#">Live Preview Kit</a>
                </div>
            </div>
        </div>
